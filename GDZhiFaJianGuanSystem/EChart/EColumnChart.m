...
- (void)reloadData
{
    ...
    for (int i = 0; i < totalColumnsRequired; i++)
    {
        ...
        {
            eColumnChartLabel = [[EColumnChartLabel alloc] initWithFrame:CGRectMake(widthOfTheColumnShouldBe * 0.5 + (i * widthOfTheColumnShouldBe * 1.5), self.frame.size.height, widthOfTheColumnShouldBe, 80)];
            [eColumnChartLabel setTextAlignment:NSTextAlignmentCenter];
